...
class ConnectionService: NSObject {
    ...
    private func activateConfig(at configURL: URL, authUserPassURL: URL?, handler: @escaping (Result<Void>) -> ()) {
        ...
        let upScript = bundle.url(forResource: "client.up.tunnelblick", withExtension: "sh", subdirectory: ConnectionService.openVPNSubdirectory)!
        let downScript = bundle.url(forResource: "client.down.tunnelblick", withExtension: "sh", subdirectory: ConnectionService.openVPNSubdirectory)!
